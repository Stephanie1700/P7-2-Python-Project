...
if __name__=='__main__':
    # Step 1: Load dictionary aka the AFINN dict
    ...
    if input_text == "":
        ...
        # Step 4: Calculate the score for each sentence
        sentence_scores = [] 
        ...
        # Step 6: Separate positive, negative, & neutral sentences yurh
        positive_sentences = []
        negative_sentences = []
        neutral_sentences = []
        for sentenceLs in sentence_scores:
        ...
        # Step 7: Find most positive and most negative sentences onlyyy
        most_positive = None
        most_negative = None 
